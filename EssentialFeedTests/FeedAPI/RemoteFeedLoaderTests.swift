...
class RemoteFeedLoaderTests: XCTestCase {
   ...
   func test_load_deliversErrorOn200HTTPResponceWithInvalidJSON() {
   ...
   private func makeItem(id: UUID, description: String? = nil, location: String? = nil, imageURL: URL) -> (model: FeedItem, json: [String: Any]) {
      ...
      ].compactMapValues { value in value }
   ...
   private func expect(_ sut: RemoteFeedLoader, toCompleteWith expectedResult: RemoteFeedLoader.Result, when action: () -> Void, file: StaticString = #filePath, line: UInt = #line) {
      ...
      sut.load { recievedResult in
         ...
         case let (.success(recievedItem), .success(expectedItem)):
            XCTAssertEqual(recievedItem, expectedItem, file: file, line: line)
